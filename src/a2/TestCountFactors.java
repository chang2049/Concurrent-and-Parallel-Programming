...
//        System.out.printf("Total number of factors is %9d%n", count);
        System.out.println(countPrimeFactorsParallelAtomic(5_000_000, 10));
    }
    ...
    public static int countPrimeFactorsParallel(int number, int n) {
        ...
        for(int i =0; i<n;i++){
            ...
            threads.add(new Thread(()->{
                for(int v = number/n*ti;v<(number/n*(ti+1)>number?number:number/n*(ti+1));v++){
    ...
    public static int countPrimeFactorsParallelAtomic(int number, int n) {
